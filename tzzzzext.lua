...
-- Tạo giao diện "Hop Server" trên góc trái
...
textButton.Size = UDim2.new(0, 200, 0, 50) -- Kích thước nút
textButton.Position = UDim2.new(0, 10, 0, 10) -- Vị trí nút góc trái
textButton.BackgroundColor3 = Color3.fromRGB(0, 170, 255) -- Màu nền xanh
