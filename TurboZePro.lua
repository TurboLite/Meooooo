...
local Tabs = {
    infor = Window:AddTab({ Title = "Tab Home", Icon = "" }),
    ...
    Qs = Window:AddTab({ Title = "Misc Server", Icon = "" }),
    ...
    De = Window:AddTab({ Title = "Devil Fruit", Icon = "" }),   
    Lc = Window:AddTab({ Title = "Dịch Chuyển", Icon = "" }),     
    Ms = Window:AddTab({ Title = "Title", Icon ="" }),           
...
task.spawn(function()
    ...
    local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Ẩn Hiệu Ứng", Default = True })
...
DropdownTweenSpeed:OnChanged(function(Value)
    ...
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Ramdom Xương", Default = false })
...
spawn(function()
 ...
 local ObservationRange = Tabs.Qs:AddParagraph({
   ...
   Tabs.Qs:AddSection("Auto Farm Chest")
...
if _G.ChestBypass then
 ...
 spawn(function()
    ...
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Đánh Boss Soul Reaper", Default = false })
